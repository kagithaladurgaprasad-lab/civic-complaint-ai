...
from complaint_embeddings import (
...
def create_complaint(
    ...
    # ========================================================
    # 6. EXTRACT SLA INFORMATION
    # ========================================================

    if municipal_sla:

        municipal_sla_days = (
            municipal_sla.get("sla_days")
        )

        municipal_sla_service = (
            municipal_sla.get("service")
        )

        municipal_sla_department = (
            municipal_sla.get("department")
        )

        municipal_sla_source = (
            municipal_sla.get("source")
        )
    ...
    # ========================================================
    # 9. STORE TEXT EMBEDDING IN QDRANT
    # ========================================================
...
def get_complaint_details(
    ...
    if complaint.municipal_sla_days is not None:
        ...
        municipal_sla = {
            ...
            "service": (
                complaint.municipal_sla_service
            ),

            "sla_days": (
                complaint.municipal_sla_days
            ),

            "department": (
                complaint.municipal_sla_department
            ),

            "source": (
                complaint.municipal_sla_source
            ),
